...
function spawnSync(command, args, options = {
    ...
    const ret = cp.spawnSync(command, args, options);
    if (ret.stderr) {
        throw new Error(`${ret.stderr}`);
    }
    return ret;
}
exports["default"] = spawnSync;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const ai_1 = __importDefault(__nccwpck_require__(3860));
const sfDiff = __importStar(__nccwpck_require__(1214));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            sfDiff.prep();
...
const cp_1 = __importDefault(__nccwpck_require__(240));
dotenv.config();
const ROOT_DIR_UNSANITIZED = core.getInput('root_dir') || './';
const ROOT_DIR = ROOT_DIR_UNSANITIZED.endsWith('/')
...
const DIFF_DIR_UNSANITIZED = core.getInput('diff_dir') || 'sfDiffOutput/';
const DIFF_DIR = DIFF_DIR_UNSANITIZED.endsWith('/')
